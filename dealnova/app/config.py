...
class Config:
    ...
    ANALYTICS_FLUSH_ENABLED = _env_bool.__func__("ANALYTICS_FLUSH_ENABLED", True)
    ANALYTICS_FLUSH_MIN_INTERVAL_SECONDS = int(os.getenv("ANALYTICS_FLUSH_MIN_INTERVAL_SECONDS", "60"))
    ANALYTICS_FLUSH_LOCK_SECONDS = int(os.getenv("ANALYTICS_FLUSH_LOCK_SECONDS", "20"))
    ...
    FULL_BACKUP_KEEP_LATEST_ONLY = _env_bool.__func__("FULL_BACKUP_KEEP_LATEST_ONLY", False)
